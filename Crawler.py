...
result = pyfiglet.figlet_format("BY:-MEET & RAHUL", font="digital")
print(bColors.RED + result)

result2 = pyfiglet.figlet_format("VIEH GROUP", font="slant")
print(bColors.YELLOW + result2)
print("                                                              - @meetpandya_19,@vgnn524,@viehgroup")
...
if user == "1":
    ...
    with open("/home/kageyama/PycharmProjects/pythonProject/Tools/subdomains-wodlist.txt", "r") as wordlist_file:
    ...
    subdomain = input(f"\n[+] You Select Option {user} , Enter Your Target URL: ")
    with open("/home/kageyama/PycharmProjects/pythonProject/Tools/files-and-dirs-wordlist.txt", "r") as wordlist_file:
        for line in wordlist_file:
            word = line.strip()
